...
class m260621_100822_add_payload_fields extends Migration
{
    public function up()
    {
        $this->addColumn('submitted_flight_plan', 'crew',          $this->smallInteger()->unsigned()->null());
        ...
        $this->addColumn('flight', 'crew',          $this->smallInteger()->unsigned()->null());
    ...
    {
        $this->dropColumn('submitted_flight_plan', 'crew');
