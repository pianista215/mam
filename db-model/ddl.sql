...
CREATE TABLE `aircrafts` (
  ...
  CONSTRAINT `aircrafts_aircraft_types_FK` FOREIGN KEY (`aircraft_type_id`) REFERENCES `aircraft_types` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `aircrafts_airports_FK` FOREIGN KEY (`location`) REFERENCES `airports` (`icao_code`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `airports` (
  ...
  CONSTRAINT `airports_countries_FK` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `pilots` (
  ...
  CONSTRAINT `pilots_countries_FK` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `routes` (
  ...
  CONSTRAINT `routes_airports_arrival_FK` FOREIGN KEY (`arrival`) REFERENCES `airports` (`icao_code`),
  CONSTRAINT `routes_airports_departure_FK` FOREIGN KEY (`departure`) REFERENCES `airports` (`icao_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE `submitted_flightplans` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
